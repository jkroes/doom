...
between the two."
  ...
  (map! :map org-mode-map
        ...
        (:prefix ("a" . "attachments")
         "a" #'org-attach
         "<backspace>" #'delete-empty-org-attach-id-dirs
  ...
  (let-alist evil-org-movement-bindings
    (let ((Cright  (concat "C-" .right))
      ...
      (map! :map evil-org-mode-map
            ...
            ;; Insert heading after current subtree
            :ni [M-return] #'org-insert-heading-respect-content
            ;; Insert heading after parent subtree
            :ni [M-S-return] (cmd! (let ((current-prefix-arg '(16))) (call-interactively #'org-insert-heading)))
