    ...
    (let* ((context (org-element-context))
      ...
      (pcase type
        ((or `citation `citation-reference)
         ...
         ;; TODO Should I simply remove the calls to org-update-checkbox-count,
         ;; etc.? Are they useful, or do they simply insert cookies where they
         ;; don't belong in tandem with my automatic cookie insertion code?
        (`headline
